...
CSCMake2DRecHit::CSCMake2DRecHit(const edm::ParameterSet& ps):
  ...
  useCalib            = false;//ps.getParameter<bool>("CSCUseCalibrations");
  stripWireDeltaTime  = 8;//ps.getParameter<int>("CSCstripWireDeltaTime"); //@@ Non-standard  CSC*s*trip...
  useTimingCorrections= false;//ps.getParameter<bool>("CSCUseTimingCorrections");
  useGasGainCorrections = false;//ps.getParameter<bool>("CSCUseGasGainCorrections");
